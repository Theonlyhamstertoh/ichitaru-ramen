    ...
    <div className="container-fluid location">
      ...
      <div className="container mapcontact">
        <div className="map">
          <a href="https://google.com">
            <img className="mapImg" src="assets/icons/map.png" alt="" />
          </a>
        </div>
        <div className="contact">
          ...
          <p className="address">5721 Lincoln Ave Ste F, Cypress, CA 90630</p>
          <p className="hours">
      ...
      <div className="container mapcontact">
        ...
        <div className="contact">
          ...
          <p className="address">7040 Avenida Encinas, Carlsbad, CA 92011</p>
          <p className="hours">
            Sun 11:00 am - 9:00 pm <br />
            Mon 11:00 am - 9:00 pm
            <br />
